...
const CrowdfunderCalculator = () => {
	...
	const [fundingPercentage, setFundingPercentage] = useState(50); // Updated initial value to 50%
	...
	const validateInputs = () => {
		...
		if (!amount) {
			...
			if (value < 300) {
				...
				let percentage = 50; // Updated base percentage to 50%
				if (isInDeprivedArea(postcode) || (selectedGroups.length > 0 && !selectedGroups.includes('none'))) {
					percentage = 60; // Updated to 60% for both deprived areas and priority groups
				}
		...
		return (
			<div className="sw-container sw-card">
			  ...
			  <div className="pb-4 mb-6">
				 ...
				 <a href="https://www.sport.wales/grants-and-funding/crowdfunder/"
					...
					{wimdInfo && (
					  <div className="sw-results">
						<p className="font-semibold">
						  ...
						  {wimdInfo.isDeprived &&
							" - Yn gymwys am hyd at 60% o gyllid cyfatebol"
						  }
						</p>
					  </div>
					)}
					  ...
					  <div className="space-y-4">
						...
						<div className="bg-white bg-opacity-10 p-4 rounded-lg">
						  <p className="text-lg pb-2">
							Cefnogwyr Unigryw Gofynnol: <span className='pl-2 font-semibold'>{getRequiredSupporters(totalProjectValue)}</span>
						  </p>
				...
				<div className="lg:col-span-1 space-y-6">
				  <div className="sw-sidebar-card">
					...
					<p className="text-[--color-sw-blue]">
					  ...
					  <a href="https://www.crowdfunder.co.uk/cy/cronfeydd/chwaraeon-cymru"
					  target="_blank"
					  ...
					  Bydd Chwaraeon Cymru yn cyfateb hyd at 60% o'ch targed codi arian, yn dibynnu ar eich lleoliad a nodau'r prosiect.
					</p>
				  </div>
				  ...
				  <div className="sw-sidebar-card">
					...
					<p className="text-[--color-sw-blue]">
					  ...
					  Mae  
					 <a href="https://statscymru.llyw.cymru/Catalogue/Community-Safety-and-Social-Inclusion/Welsh-Index-of-Multiple-Deprivation"
					  target="_blank"
					  rel="noopener noreferrer"
					  className="text-blue-700 underline hover:no-underline"
					  >
					  ...
					  Gall prosiectau mewn ardaloedd mwy difreintiedig (30% uchaf) dderbyn hyd at 60% o gyllid cyfatebol.
					</p>
				  </div>
				  ...
				  <div className="sw-sidebar-card">
					...
					<ul className="text-[--color-sw-blue] space-y-2">
					  <li className='pt-2'>• Lefel sylfaenol: 50% o gyllid cyfatebol</li>
					  <li className='pt-2'>• Cefnogi grwpiau blaenoriaeth: 60% o gyllid cyfatebol</li>
					  <li className='pt-2'>• Ardaloedd MALlC 30% uchaf: 60% o gyllid cyfatebol</li>
