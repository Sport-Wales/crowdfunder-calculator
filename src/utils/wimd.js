import wimdData from '../data/wimd_data_2025.json'; // WIMD 2025 data
...
const processWIMDData = () => {
  ...
  wimdData.forEach(entry => {
    ...
    const wimdRank = parseInt(entry['WIMD 2025 Rank']);
...
export const isInDeprivedArea = (postcode) => {
  ...
  // Check if the rank exists and is in the top 30% (ranks 1-575)
  // WIMD 2025 has 1,917 LSOAs, so top 30% = 1917 × 0.30 = 575
  return wimdRank && wimdRank <= 575;
};
